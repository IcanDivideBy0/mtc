    ...
    <Layout>
      <Grid container spacing={4}>
        <Grid item xs={12}>
          ...
          <Typography paragraph>
            De façon schématique, une douleur, une gêne physique ou moral est
            due à un blocage. Grâce aux différents outils de la médecine
            énergétique chinoise, je pourrai lever ces blocages et ainsi
            remettre en circulation vos énergies et faciliter l’autoguérison du
            corps.
          </Typography>
        </Grid>
            ...
            <Grid item xs={12} md={8} className={classes.cardMedia}>
              <CardContent className={classes.cardContent}>
                ...
                <Typography>
                  ...
                  L’acupuncture permet de re-équilibrer et harmoniser les
                  énergies et de relancer leur circulation.
                </Typography>
              </CardContent>
            </Grid>
          </Card>
            ...
            <Grid item xs={12} md={8} className={classes.cardMedia}>
              <CardContent className={classes.cardContent}>
                ...
                <Typography>
                  ...
                  adipeuses et premières couches des muscles). Elles sont
                  idéales pour lever certaines stagnations, et donc aider à une
                  bonne circulation.
                </Typography>
              </CardContent>
            </Grid>
          ...
          >
            ...
            <Grid item xs={12} md={8} className={classes.cardMedia}>
              <CardContent className={classes.cardContent}>
                ...
                <Typography>
                  Les Moxas sont des batons d’armoise ressemblant à des cigare.
                  On s’en sert essentiellement chauffer les points d’acupuncture
                  et ainsi re-énergiser la personne, chasser le froid du corps
                  et apaiser certaines douleurs physique ou psychique.
                </Typography>
              </CardContent>
            </Grid>
          </Card>
